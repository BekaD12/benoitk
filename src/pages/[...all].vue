...
<template>
  <div class="error">
    <svg id="monkey_404" viewBox="0 0 800 480" @click="router.back()">
      ...
      <g id="number_4_2">
        <path id="number_4_outline_2" class="st13"
      ...
      <g id="sword">
        <path id="sword_handle" class="st4"
    ...
    <button @click="router.back()" class="error-btn" href="">{{ t('button.back') }}</button>
  </div>
</template>
